...
public class Task_3 {
    ...
    public static int[] divArrays(int[] firstArray, int[] secondArray) {
        if (firstArray == null || secondArray == null) throw new RuntimeException("Массивы отсутствуют");
        if(firstArray.length != secondArray.length) throw new RuntimeException("Значения длин массивов отличаются");
